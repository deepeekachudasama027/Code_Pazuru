...
// Question.insertMany([{level:'1',order:['<html>','<head>','<title> web puzzle </title>','</head>','</html>'],code:['</html>','<title> web puzzle </title>','<head>','<html>','</head>']}]);

// Question.insertMany([{level:'2',order:['<html>','<head>','<title> web puzzle </title>','<body>','</body>','</head>','</html>'],code:['<title> web puzzle </title>','<html>','<head>','</body>','</html>','<body>','</head>']}]);
