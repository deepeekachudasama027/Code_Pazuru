...
exports.register = async (req, res, next) => {
  const { username,institute, email, password } = req.body;
  try {
...
// const startDate =  new Date("2021-10-04T10:30:00Z").getTime();
// const endDate =  new Date("2021-10-04T12:30:00Z").getTime();
